...
async def list_agents(session: DbSession) -> list[AgentListItemResponse]:
...
async def get_agent(agent_id: str, session: DbSession) -> AgentDetailResponse:
...
async def execute_agent_route(
    agent_id: str, request: AgentExecuteRequest, session: DbSession
